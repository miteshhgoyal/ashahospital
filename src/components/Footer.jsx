...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b  border-t border-gray-200">
      {/* Main Footer Content */}
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            ...
            <div className="flex-1 max-w-md">
              ...
              <div className="flex">
                ...
                />
                <button className="bg-gradient-to-r from-blue-600 to-blue-600 text-white px-6 py-3 rounded-r-xl hover:shadow-lg transition-all duration-300 flex items-center gap-2 font-medium">
            ...
            <div className="text-center lg:text-right">
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  href="#instagram"
                  className="w-12 h-12  hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-xl flex items-center justify-center transition-all duration-300 group shadow-sm hover:shadow-md"
                >
                  <Instagram className="w-5 h-5 text-gray-600 group-hover:text-blue-600 group-hover:scale-110 transition-all" />
                </a>
                <a
                  href="#twitter"
                  className="w-12 h-12  hover: border border-gray-200 hover:border-blue-300 rounded-xl flex items-center justify-center transition-all duration-300 group shadow-sm hover:shadow-md"
                ...
                <a
                  ...
                  className="w-12 h-12  hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-xl flex items-center justify-center transition-all duration-300 group shadow-sm hover:shadow-md"
                >
                  <Youtube className="w-5 h-5 text-gray-600 group-hover:text-blue-600 group-hover:scale-110 transition-all" />
                </a>
              </div>
            </div>
          </div>
